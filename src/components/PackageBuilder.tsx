...
const PackageBuilder = () => {
  ...
  const handleEnquire = () => {
    const formattedDate = date ? format(date, "EEEE, MMMM do, yyyy") : "Date not selected";
...
_I would like to check availability for this custom package._`;
  ...
  return (
    <section id="package-builder" className="py-20 lg:py-28 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container px-4">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
            ...
            <motion.div 
                ...
                className="lg:col-span-8 bg-card rounded-3xl p-6 md:p-10 shadow-soft border border-border/50"
            >
                <div className="space-y-10">
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-xl font-bold text-foreground">{duration[0]} Hours</span>
                        </div>
                        <Slider
                            value={duration}
                            min={2}
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-xl font-bold text-foreground">{guests[0]} People</span>
                        </div>
                        <Slider
                            value={guests}
                            min={2}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className={`flex items-start space-x-3 p-4 rounded-xl border transition-all cursor-pointer ${addOns.catering ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`}
                                onClick={() => setAddOns(prev => ({...prev, catering: !prev.catering}))}
                            >
                                <Checkbox checked={addOns.catering} id="catering" className="mt-1" />
                                <div className="grid gap-1.5 leading-none pointer-events-none">
                                    ...
                                    >
                                        <Utensils className="w-4 h-4 text-cta" /> Premium Catering
                                    </label>
                            ...
                            <div className={`flex items-start space-x-3 p-4 rounded-xl border transition-all cursor-pointer ${addOns.dj ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`}
                                onClick={() => setAddOns(prev => ({...prev, dj: !prev.dj}))}
                            >
                            ...
                            <div className={`flex items-start space-x-3 p-4 rounded-xl border transition-all cursor-pointer ${addOns.photography ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`}
                                onClick={() => setAddOns(prev => ({...prev, photography: !prev.photography}))}
                            >
                                <Checkbox checked={addOns.photography} id="photography" className="mt-1" />
                                <div className="grid gap-1.5 leading-none pointer-events-none">
                                    <label
                                        htmlFor="photography"
                                        className="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2"
                            ...
                            <div className={`flex items-start space-x-3 p-4 rounded-xl border transition-all cursor-pointer ${addOns.decorations ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`}
                                onClick={() => setAddOns(prev => ({...prev, decorations: !prev.decorations}))}
                            >
                                <Checkbox checked={addOns.decorations} id="decorations" className="mt-1" />
                                <div className="grid gap-1.5 leading-none pointer-events-none">
                                    <label
                                        htmlFor="decorations"
                                        className="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2"
            ...
            >
                <div className="bg-foreground text-background rounded-3xl p-8 shadow-elevated">
                    <div className="flex flex-col items-center text-center space-y-6">
                        ...
                        <div>
                             <h3 className="text-xl font-medium opacity-90">Estimated Budget</h3>
                             <p className="text-4xl md:text-5xl font-bold font-display mt-2">
                                ${estimatedBudget}
                             </p>
                             <p className="text-sm opacity-60 mt-2">*Prices are approximate</p>
                        </div>
